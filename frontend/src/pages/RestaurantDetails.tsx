...
import { Tabs, TabsList, TabsTrigger, TabsContent } from "@/components/ui/tabs"; // Add Tabs components
import { toast } from "@/components/ui/use-toast";
import RestaurantAdminNavigation from "@/components/RestaurantAdminNavigation";
import RestaurantOrders from "@/pages/RestaurantOrders"; // Import RestaurantOrders
...
const RestaurantDetails = () => {
  ...
  const [activeTab, setActiveTab] = useState<"details" | "orders">("details"); // Track active tab
    ...
    <div className="flex">
      ...
      <div className="flex-1 p-8">
        <div className="p-6 max-w-5xl mx-auto space-y-6">
          {/* Tab Navigation */}
          <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as "details" | "orders")} className="w-full">
